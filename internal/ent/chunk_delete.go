...
func (cd *ChunkDelete) Exec(ctx context.Context) (int, error) {
	return withHooks[int, ChunkMutation](ctx, cd.sqlExec, cd.mutation, cd.hooks)
}
...
func (cd *ChunkDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(chunk.Table, sqlgraph.NewFieldSpec(chunk.FieldID, field.TypeString))
